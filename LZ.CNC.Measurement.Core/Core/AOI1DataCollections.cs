...
{
    [Serializable]
    public class AOI1DataCollections : ConfigBase
    {
        ...
        public new static AOI1DataCollections Load()
        {
            string path = System.IO.Path.Combine(GetApplicationPath("detectdatas"), string.Format("bend1_{0}.dds", DateTime.Now.ToString("yyyy-MM-dd")));
            return Load(path) as AOI1DataCollections;
        }
        ...
        public override bool Save()
        {
            ...
            path = System.IO.Path.Combine(GetApplicationPath("detectdatas"), string.Format("bend1_{0}.dds", DateTime.Now.ToString("yyyy-MM-dd")));
            return Save(path);
        }
    }
}
