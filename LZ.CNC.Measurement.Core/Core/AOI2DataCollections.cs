...
{
    [Serializable]
    public class AOI2DataCollections : ConfigBase
    {
        ...
        public new static AOI2DataCollections Load()
        {
            string path = System.IO.Path.Combine(GetApplicationPath("detectdatas"), string.Format("bend2_{0}.dds", DateTime.Now.ToString("yyyy-MM-dd")));
            return Load(path) as AOI2DataCollections;
        }
        ...
        public override bool Save()
        {
            ...
            path = System.IO.Path.Combine(GetApplicationPath("detectdatas"), string.Format("bend2_{0}.dds", DateTime.Now.ToString("yyyy-MM-dd")));
            return Save(path);
        }
    }
}
