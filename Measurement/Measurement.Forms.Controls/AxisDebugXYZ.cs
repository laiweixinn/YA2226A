...
{
    public partial class AxisDebugXYZ : UserControl
    {
        public AxisDebugXYZ()
        {
            InitializeComponent();
        ...
        private void Mouse_Down(object sender, MouseEventArgs e)
        {
            ...
            if (_Axis != null)
            {
                ...
                if (dist > 0)
                {
                    if (sender == btn_ydec|| sender==btn_xdec|| sender==btn_zdec)
                    {
                        dist = -dist;
                    }
                    double speed = 0;
        ...
        private void AxisDebugXYZ_Load(object sender, EventArgs e)
        {
