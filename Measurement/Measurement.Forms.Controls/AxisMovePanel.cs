...
{
    public partial class AxisMovePanel : UserControl
    {
        public AxisMovePanel()
        {
            InitializeComponent();
            Refresh();
        }
        ...
        private void SetAxisStatus(bool eln, bool elp, bool org, bool alm,bool son)
        {
            ...
            btn_Enable.BackColor = (son ? Color.Green : Color.Red);
        }
        ...
        {
            bool Status=false;
            if (Axis.ReadSEVON(ref Status))
            {
                Axis.WriteSEVON(!Status);
            }
        }
    }
}
